...
impl AbstractSyntaxGraph {
    ...
    pub fn add_node_property(&mut self, node_id: AbstractSyntaxGraphNodeId, property: AbstractSyntaxTokenProperty) {
...
impl AbstractSyntaxGraphNode {
    ...
    pub fn new(from: AbstractSyntaxTokenType, parent: AbstractSyntaxGraphNodeId) -> Self {
        Self {
            node_type: from,
            parent,
            children: vec!(),
